...
pub struct ScopeRecord {
    ...
    ///
    /// **This is how a host finds the room a spine guaranteed.** CrawlStar must know *which* Space is
    /// the Rest Sanctum in order to place its Obelisk interaction; a Zelda-like must know which is the
...
impl WorldDescriptor {
    ...
    /// "which room is the sanctum?" without re-deriving structure the generator already knew.
