...
//! sphere 2: sanctum                (after the dash found in sphere 1)
//! ```
//!
...
pub struct MissionGraph {
    ...
    /// declared by something that already ran — a spine promising a dead-end sanctum — and has to
...
impl MissionGraph {
    ...
    ///
    /// This is how "the sanctum is a dead end" survives `cycle_density`: once declared, no later pass
